...
urlpatterns = [
    ...
    path(
        "groups_list/",
        cache_page(60 * 15)(views.GroupListView.as_view()),
        name="groups_list",
    ),
    path("group/<int:pk>", cache_page(60 * 15)(views.GroupDetailView), name="group"),
    path(
        "groups/invite/<str:username>/<int:pk>/", views.GroupInvite, name="group_invite"
    ),
    ...
    path(
        "groups/group_kik/<str:username>/<int:pk>/", views.kik_group, name="group_kik"
    ),
    path("groups/group_create/", views.GroupCreateView.as_view(), name="group_create"),
    path(
        "groups/group_update/<int:pk>/",
        views.GroupUpdateView.as_view(),
        name="group_update",
    ),
    path(
        "groups/group_delete/<int:pk>/",
